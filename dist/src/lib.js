...
exports.verifyLegacy = exports.fetchLegacy = exports.hash = exports.verify = exports.fetch = exports.publish = void 0;
...
function publish(fileHash, tag, provider, cb) {
    return __awaiter(this, void 0, void 0, function () {
        var client, convertedIndex, msg, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    client = new iota_js_1.SingleNodeClient(provider);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    convertedIndex = iota_js_1.Converter.utf8ToBytes(tag);
                    return [4 /*yield*/, iota_js_1.sendData(client, convertedIndex, iota_js_1.Converter.utf8ToBytes(fileHash))];
                case 2:
                    msg = _a.sent();
                    if (cb) {
                        cb(msg);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, client.message(messageId)];
                case 2:
                    message = _a.sent();
                    if (!message) {
                        throw "Message with specified messageId " + messageId + " could not be found";
                    }
                    if (message.payload && utils_1.utils.isIndexationPayload(message.payload)) {
                        dataInUtf8 = iota_js_1.Converter.hexToUtf8(message.payload.data);
